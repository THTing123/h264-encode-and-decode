...
if(BUILD_STATIC)
  ...
  if(GNUTLS_FOUND)
    ...
    set(GNUTLS_LIBRARIES "-Wl,-Bstatic -lgnutls -lpthread -lzstd -lbrotlienc -lbrotlidec -lbrotlicommon")
...
if(BUILD_STATIC_GCC)
  ...
  if(WIN32)
    #set(STATIC_BASE_LIBRARIES "${STATIC_BASE_LIBRARIES} -lmingw32 -lgcc_eh -lgcc -lmoldname -lmingwex -lmsvcrt")//modify-htt
