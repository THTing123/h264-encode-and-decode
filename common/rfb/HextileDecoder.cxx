...
static LogWriter vlog("HextileDecoder");
                              ...
                              const ServerParams& server, rdr::OutStream* os)
{
  ...
  vlog.debug("readRect position-tl(%d, %d), position-br(%d, %d)", r.tl.x, r.tl.y, r.br.x, r.br.y);
  is->setRestorePoint();
                                ...
                                ModifiablePixelBuffer* pb)
{
  ...
  vlog.debug("decodeRect pf.bpp(%d)", pf.bpp);
  switch (pf.bpp) {
